...
def Resnet_Model():
    ...
    hash_value = tf.keras.layers.Dense(units=c.hash_bit, activation=None, kernel_regularizer=regularizers.l2(0.001))(x)
    ...
    prediction = tf.keras.layers.Dense(units=c.num_class, activation="softmax",
